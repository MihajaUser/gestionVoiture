<div>
  <div style="margin-left: 25%;">
    <h2 class="h4 pd-20"> Modifier Visite  <?= $numero?></h2>
    <div class="card" style="width: 50%;">   
      <div class="card-body" style="margin-left: 20%;">
        <form action="<?php echo site_url('') ?>modifier-visite-voiture-gestion-de-voiture" method="post" enctype="multipart/form-data">
